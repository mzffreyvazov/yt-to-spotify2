...
**Load**: `view .agents/skills/logging-patterns/SKILL.md`

---

## Description

Java logging best practices with SLF4J, structured logging (JSON), and MDC for request tracing. Includes AI-friendly log formats optimized for Codex analysis.
...
**JSON logs are better for AI/Codex analysis:**
...
| Topic | Description |
|-------|-------------|
| **AI-Friendly Logging** | JSON formats optimized for Codex analysis |
